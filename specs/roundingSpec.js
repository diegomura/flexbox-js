...
describe('Rounding', () => {
  ...
  test('rounding_flex_basis_flex_grow_row_prime_number_width', () => {
    ...
    const root_child3 = flexbox.Node.create();
    root_child3.setFlexGrow(1);
    root.insertChild(root_child3, 3);

    const root_child4 = flexbox.Node.create();
  ...
  test('rounding_total_fractial_nested', () => {
    ...
    root_child0_child0.setPosition(flexbox.EDGE_BOTTOM, 13.3);
    ...
    root_child0_child1.setPosition(flexbox.EDGE_TOP, 13.3);
  ...
  test('rounding_fractial_input_3', () => {
    const root = flexbox.Node.create();
    root.setPosition(flexbox.EDGE_TOP, 0.3);
    root.setWidth(100);
    root.setHeight(113.4);
  ...
  test('rounding_fractial_input_4', () => {
    const root = flexbox.Node.create();
    root.setPosition(flexbox.EDGE_TOP, 0.7);
    root.setWidth(100);
    root.setHeight(113.4);
  ...
  test('rounding_inner_node_controversy_combined', () => {
    ...
    const root_child1_child2 = flexbox.Node.create();

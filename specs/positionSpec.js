...
describe('Position', () => {
  ...
  test('should have same top position by default', () => {
    expect(yogaNode.getPosition(yoga.EDGE_TOP)).toEqual(flexboxNode.getPosition(flexbox.EDGE_TOP));
  });

  test('should have same left position by default', () => {
    expect(yogaNode.getPosition(yoga.EDGE_LEFT)).toEqual(flexboxNode.getPosition(flexbox.EDGE_LEFT));
  });

  test('should have same bottom position by default', () => {
    expect(yogaNode.getPosition(yoga.EDGE_BOTTOM)).toEqual(flexboxNode.getPosition(flexbox.EDGE_BOTTOM));
  });

  test('should have same right position by default', () => {
    expect(yogaNode.getPosition(yoga.EDGE_RIGHT)).toEqual(flexboxNode.getPosition(flexbox.EDGE_RIGHT));
  });

  test('should have same vertical position by default', () => {
    expect(yogaNode.getPosition(yoga.EDGE_VERTICAL)).toEqual(flexboxNode.getPosition(flexbox.EDGE_VERTICAL));
  });

  test('should have same horizontal position by default', () => {
    expect(yogaNode.getPosition(yoga.EDGE_HORIZONTAL)).toEqual(flexboxNode.getPosition(flexbox.EDGE_HORIZONTAL));
  });

  test('should have same start position by default', () => {
    expect(yogaNode.getPosition(yoga.EDGE_START)).toEqual(flexboxNode.getPosition(flexbox.EDGE_START));
  });

  test('should have same end position by default', () => {
    expect(yogaNode.getPosition(yoga.EDGE_END)).toEqual(flexboxNode.getPosition(flexbox.EDGE_END));
  });

  test('should have same all position by default', () => {
    expect(yogaNode.getPosition(yoga.EDGE_ALL)).toEqual(flexboxNode.getPosition(flexbox.EDGE_ALL));
  });

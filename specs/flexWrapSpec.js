...
describe('Flex wrap', () => {
  ...
  test('flex_wrap_wrap_to_child_height', () => {
    ...
    child0.setAlignItems(flexbox.ALIGN_FLEX_START);
    child0.setFlexWrap(flexbox.WRAP_WRAP);
    root.insertChild(child0, 0);
  ...
  test('wrap_reverse_row_align_content_center', () => {
    const root = flexbox.Node.create();
    root.setFlexDirection(flexbox.FLEX_DIRECTION_ROW);
    root.setAlignContent(flexbox.ALIGN_CENTER);
    root.setFlexWrap(flexbox.WRAP_WRAP_REVERSE);
    root.setWidth(100);
  ...
  test('wrapped_column_max_height', () => {
    ...
    const child1 = flexbox.Node.create();
    child1.setMargin(flexbox.EDGE_LEFT, 20);
    child1.setMargin(flexbox.EDGE_TOP, 20);
    child1.setMargin(flexbox.EDGE_RIGHT, 20);
    child1.setMargin(flexbox.EDGE_BOTTOM, 20);
    child1.setWidth(200);

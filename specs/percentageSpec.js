...
describe('Percentage', () => {
  ...
  test('percentage_position_left_top', () => {
    ...
    const root_child0 = flexbox.Node.create();
    root_child0.setPositionPercent(flexbox.EDGE_LEFT, 10);
    root_child0.setPositionPercent(flexbox.EDGE_TOP, 20);
  ...
  test('percentage_position_bottom_right', () => {
    ...
    const root_child0 = flexbox.Node.create();
    root_child0.setPositionPercent(flexbox.EDGE_RIGHT, 20);
    root_child0.setPositionPercent(flexbox.EDGE_BOTTOM, 10);
  ...
  test('percentage_flex_basis', () => {
    ...
    const root_child1 = flexbox.Node.create();
  ...
  test('percentage_multiple_nested_with_padding_margin_and_percentage_values', () => {
    ...
    root_child0.setFlexGrow(1);
    root_child0.setFlexBasisPercent(10);
    root_child0.setMargin(flexbox.EDGE_LEFT, 5);
    root_child0.setMargin(flexbox.EDGE_TOP, 5);
    root_child0.setMargin(flexbox.EDGE_RIGHT, 5);
    root_child0.setMargin(flexbox.EDGE_BOTTOM, 5);
    root_child0.setPadding(flexbox.EDGE_LEFT, 3);
    root_child0.setPadding(flexbox.EDGE_TOP, 3);
    root_child0.setPadding(flexbox.EDGE_RIGHT, 3);
    root_child0.setPadding(flexbox.EDGE_BOTTOM, 3);
    root_child0.setMinWidthPercent(60);
    root.insertChild(root_child0, 0);

    const root_child0_child0 = flexbox.Node.create();
    root_child0_child0.setMargin(flexbox.EDGE_LEFT, 5);
    root_child0_child0.setMargin(flexbox.EDGE_TOP, 5);
    root_child0_child0.setMargin(flexbox.EDGE_RIGHT, 5);
    root_child0_child0.setMargin(flexbox.EDGE_BOTTOM, 5);
    root_child0_child0.setPaddingPercent(flexbox.EDGE_LEFT, 3);
    root_child0_child0.setPaddingPercent(flexbox.EDGE_TOP, 3);
    root_child0_child0.setPaddingPercent(flexbox.EDGE_RIGHT, 3);
    root_child0_child0.setPaddingPercent(flexbox.EDGE_BOTTOM, 3);
    root_child0_child0.setWidthPercent(50);
    root_child0.insertChild(root_child0_child0, 0);

    const root_child0_child0_child0 = flexbox.Node.create();
    root_child0_child0_child0.setMarginPercent(flexbox.EDGE_LEFT, 5);
    root_child0_child0_child0.setMarginPercent(flexbox.EDGE_TOP, 5);
    root_child0_child0_child0.setMarginPercent(flexbox.EDGE_RIGHT, 5);
    root_child0_child0_child0.setMarginPercent(flexbox.EDGE_BOTTOM, 5);
    root_child0_child0_child0.setPadding(flexbox.EDGE_LEFT, 3);
    root_child0_child0_child0.setPadding(flexbox.EDGE_TOP, 3);
    root_child0_child0_child0.setPadding(flexbox.EDGE_RIGHT, 3);
    root_child0_child0_child0.setPadding(flexbox.EDGE_BOTTOM, 3);
  ...
  test('percentage_margin_should_calculate_based_only_on_width', () => {
    ...
    const root_child0 = flexbox.Node.create();
    root_child0.setFlexGrow(1);
    root_child0.setMarginPercent(flexbox.EDGE_LEFT, 10);
    root_child0.setMarginPercent(flexbox.EDGE_TOP, 10);
    root_child0.setMarginPercent(flexbox.EDGE_RIGHT, 10);
    root_child0.setMarginPercent(flexbox.EDGE_BOTTOM, 10);
    root.insertChild(root_child0, 0);
  ...
  test('percentage_padding_should_calculate_based_only_on_width', () => {
    ...
    const root_child0 = flexbox.Node.create();
    root_child0.setFlexGrow(1);
    root_child0.setPaddingPercent(flexbox.EDGE_LEFT, 10);
    root_child0.setPaddingPercent(flexbox.EDGE_TOP, 10);
    root_child0.setPaddingPercent(flexbox.EDGE_RIGHT, 10);
    root_child0.setPaddingPercent(flexbox.EDGE_BOTTOM, 10);
    root.insertChild(root_child0, 0);
  ...
  test('percentage_absolute_position', () => {
    ...
    const root_child0 = flexbox.Node.create();
    root_child0.setPositionType(flexbox.POSITION_TYPE_ABSOLUTE);
    root_child0.setPositionPercent(flexbox.EDGE_LEFT, 30);
    root_child0.setPositionPercent(flexbox.EDGE_TOP, 10);
  ...
  test('percent_within_flex_grow', () => {
    ...
    const root_child1_child0 = flexbox.Node.create();
    root_child1_child0.setWidthPercent(100);
    root_child1.insertChild(root_child1_child0, 0);

    const root_child2 = flexbox.Node.create();
  ...
  test('percentage_container_in_wrapping_container', () => {
    ...
    const root_child0_child0 = flexbox.Node.create();
    root_child0_child0.setFlexDirection(flexbox.FLEX_DIRECTION_ROW);
    root_child0_child0.setJustifyContent(flexbox.JUSTIFY_CENTER);
    ...
    const root_child0_child0_child1 = flexbox.Node.create();
  ...
  test('percent_absolute_position', () => {
    ...
    const root_child0 = flexbox.Node.create();
    root_child0.setFlexDirection(flexbox.FLEX_DIRECTION_ROW);
    root_child0.setPositionType(flexbox.POSITION_TYPE_ABSOLUTE);
    root_child0.setPositionPercent(flexbox.EDGE_LEFT, 50);
    ...
    const root_child0_child1 = flexbox.Node.create();

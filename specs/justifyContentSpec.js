...
describe('Justify content', () => {
  ...
  test('justify_content_row_space_between', () => {
    const root = flexbox.Node.create();
    root.setFlexDirection(flexbox.FLEX_DIRECTION_ROW);
    root.setJustifyContent(flexbox.JUSTIFY_SPACE_BETWEEN);
    root.setWidth(102);
    root.setHeight(102);
  ...
  test('justify_content_row_space_around', () => {
    const root = flexbox.Node.create();
    root.setFlexDirection(flexbox.FLEX_DIRECTION_ROW);
    root.setJustifyContent(flexbox.JUSTIFY_SPACE_AROUND);
    root.setWidth(102);
    root.setHeight(102);
  ...
  test('justify_content_row_min_width_and_margin', () => {
    ...
    root.setFlexDirection(flexbox.FLEX_DIRECTION_ROW);
    root.setJustifyContent(flexbox.JUSTIFY_CENTER);
    root.setMargin(flexbox.EDGE_LEFT, 100);
    root.setMinWidth(50);
  ...
  test('justify_content_column_min_height_and_margin', () => {
    const root = flexbox.Node.create();
    root.setJustifyContent(flexbox.JUSTIFY_CENTER);
    root.setMargin(flexbox.EDGE_TOP, 100);
  ...
  test('justify_content_column_space_evenly', () => {
    const root = flexbox.Node.create();
    root.setJustifyContent(flexbox.JUSTIFY_SPACE_EVENLY);
    root.setWidth(102);
    root.setHeight(102);
